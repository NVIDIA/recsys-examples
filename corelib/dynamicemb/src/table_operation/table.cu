...
void bind_table_operation(py::module &m) {
  ...
  m.def("table_rollback_failed_evictions",
        &dyn_emb::table_rollback_failed_evictions,
        "restore cache entries whose backing insertion failed",
        py::arg("table_storage"), py::arg("table_bucket_offsets"),
        py::arg("bucket_capacity"), py::arg("incoming_keys"),
        py::arg("table_ids"), py::arg("cache_slot_indices"),
        py::arg("evicted_keys"), py::arg("evicted_scores"),
        py::arg("evicted_mask"), py::arg("storage_insert_slots"),
        py::arg("counter"), py::arg("overflow_storage") = py::none(),
        py::arg("overflow_bucket_capacity") = 0,
        py::arg("overflow_counter") = py::none(),
        py::arg("overflow_output_offsets") = py::none());

  m.def("table_update_score_by_slot", &dyn_emb::table_update_score_by_slot,
        "replace scores at masked known slots owned by expected keys",
        py::arg("table_storage"), py::arg("table_bucket_offsets"),
        py::arg("bucket_capacity"), py::arg("keys"), py::arg("slot_indices"),
  ...
  m.def("table_update_counter_with_layout",
        ...
        py::arg("overflow_output_offsets") = py::none(),
        py::arg("overflow_bucket_capacity") = 0,
        py::arg("fallback_counter") = py::none(),
        py::arg("fallback_slot_indices") = py::none(),
        py::arg("fallback_table_bucket_offsets") = py::none(),
        py::arg("fallback_bucket_capacity") = 0,
        py::arg("fallback_main_capacity") = 0,
        py::arg("fallback_num_tables") = 0,
        py::arg("fallback_overflow_output_offsets") = py::none(),
        py::arg("fallback_overflow_bucket_capacity") = 0);
