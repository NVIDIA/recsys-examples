...
MASTER_PORT=${DYNAMICEMB_MASTER_PORT:-29602}

CUDA_VISIBLE_DEVICES=0,1 torchrun \
  --nnodes 1 \
  --nproc_per_node ${MAX_GPUS} \
...
# Test pooled embedding's backward on a single GPU with different ["dim", "batch_size", "multi_hot_sizes"]
