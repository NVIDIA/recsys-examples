...
def get_test_kvcache_mgr(num_layers, blocks_in_primary_pool, page_size, offload_chunksize, enable_nvcomp = False):
    ...
    async_kvcache_mgr = AsyncHSTUKVCacheManager(
        ...
        math.ceil(kv_cache_config.max_batch_size * kv_cache_config.max_seq_len / kv_cache_config.page_size),
        4 * kv_cache_config.max_batch_size * kv_cache_config.max_seq_len,
        kv_cache_config.offload_chunksize,
        -1,
        kv_cache_config.max_seq_len,
        kv_cache_config.max_batch_size,
        4 * kv_cache_config.max_batch_size * kv_cache_config.max_seq_len,
        1, 8, 8,
        enable_nvcomp,
    )
