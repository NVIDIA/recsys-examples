...
def test_sid_retrieval_evaluator(
    ...
    target = torch.zeros(batch_size, num_candidates, dtype=torch.bool, device=device)
    ...
    log_probs[always_hit_batch_id, row_indices[always_hit_batch_id]] = log_probs[
        always_hit_batch_id, col_indices[always_hit_batch_id]
    ]
