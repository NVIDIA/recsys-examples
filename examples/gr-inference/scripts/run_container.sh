...
CONTAINER_NAME="${CONTAINER_NAME:-gr-inference-bench}"
...
CONTAINER_REPO_DIR="${CONTAINER_REPO_DIR:-/workspace/gr-inference}"
...
Start an interactive CUDA container for GR-Inference benchmarks.
...
docker_args=(
  ...
  -e "GR_CACHE_ROOT=${CONTAINER_CACHE_DIR}/gr-inference"
